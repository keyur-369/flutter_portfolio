  ...
  return (
    <section className="section py-20 bg-white/[0.01]">
      <div className="container-custom">
        ...
        <div className="relative border-l-2 border-indigo-500/30 ml-4 sm:ml-6 space-y-8 pl-6 sm:pl-10">
          {education.map((edu, i) => (
            <FadeIn key={edu.id} delay={i * 0.12} direction="left">
              <div className="relative group">
                {/* Timeline Graduation Cap Icon */}
                <div className="absolute -left-[41px] sm:-left-[61px] top-6 w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/30 border-2 border-[#090a18] group-hover:scale-110 transition-transform duration-300 z-10">
                  <GraduationCap size={16} />
                </div>

                {/* Card Container */}
                <div className="glass-card p-6 sm:p-8 border border-white/10 rounded-3xl transition-all duration-300 hover:border-indigo-500/40 hover:shadow-2xl hover:shadow-indigo-500/10">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4 pb-4 border-b border-white/[0.08]">
                    <div className="space-y-1">
                      ...
                      <p className="text-indigo-400 font-semibold text-sm sm:text-base flex items-center gap-1.5">
